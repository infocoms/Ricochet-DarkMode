...
Column {
    ...
    Rectangle {
        ...
        radius: 10
        color: (model.status === ConversationModel.Error) ? "#fc3f52" : ( model.isOutgoing ? "#3A78F0" : "#1F1F1F" ) //signal color 3A78F0
        ...
        Rectangle {
            ...
            visible: opacity > 0
            color: "#87b0ff" //SENDING COLOR TEST
        ...
        TextEdit {
            ...
            color:"white" //CHAT BUBBlE TEXT COLOR
